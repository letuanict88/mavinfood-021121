                ...
                <div class="single-slider arrows-style">
                  <div class="item">
                    <div class="d-flex flex-column">
                     <a href="/thu-vien/hinh-anh"> <img class="img-thumbnail" src="${contentModel.p1image_s}" alt=""> </a>
                  ...
                  <div class="item">
                     <div class="d-flex flex-column">
                      <a href="/thu-vien/hinh-anh"> <img class="img-thumbnail" src="${contentModel.p2image_s}" alt=""> </a>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="single-slider arrows-style">
                  <div class="item">
                    <div class="d-flex flex-column">
                      <a href="/thu-vien/video"> <img class="img-thumbnail" src="${contentModel.v1image_s}" alt=""> </a>
                  ...
                  <div class="item">
                    <div class="d-flex flex-column">
                      <a href="/thu-vien/video"> <img class="img-thumbnail" src="${contentModel.v2image_s}" alt=""> </a>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="single-slider arrows-style">
                  <div class="item">
                    <div class="d-flex flex-column">
                      <a href="/thu-vien/tai-lieu"><img class="img-thumbnail" src="${contentModel.d1image_s}" alt=""> </a>
                  ...
                  <div class="item">
                    <div class="d-flex flex-column">
                      <a href="/thu-vien/tai-lieu"> <img class="img-thumbnail" src="${contentModel.d2Image_s}" alt=""> </a>
