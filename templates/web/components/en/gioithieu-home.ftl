        ...
        <div class="row content">
          <div class="col-lg-4">
            <h1 class="base-color fst-italic">
              ...
              <span style="font-size: 3.1rem!important;">“From Farm to Table” of Mavin</span>
            ...
            <p class="fst-italic text-muted text-recommend">
              ...
              <a href="/tong-quan/chuoi-gia-tri"><span class="fw-bold text-muted pe-2" style="padding-left: 3rem; color: red;">See more  <i class="fas fa-caret-right fa-lg" style="color: red;"></i></span></a>
            </p>
          </div>
