          ...
          <div class="col" style="flex-direction: column;margin-top: 6rem;display: flex;">
            ...
            <div class="d-flex flex-lg-row flex-column justify-content-evenly mt-3">
              <div class="fs-5">
                <div class="text-muted">
                  ...
                  <div class="fw-bold base-color text-lg-end">
                    <strong id="item-price" class="currency">${contentModel.price_s}</strong> đ/túi
                  </div>
                </div>
              </div>
              <div class="d-flex flex-column text-center">
                ...
                <button type="button" class="btn btn-danger" id="addToCart">Chọn mua</button>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col mb-4 fields">
            ...
            <div class="base-bg-color shadow p-2 text-center">
              ...
              <div class="d-flex justify-content-center">
                  <div class="fs-6 text-orange me-3 currency"><span class="currency">${product.price}</span>đ</div>
