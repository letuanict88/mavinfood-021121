...
class EnRecipeSearchHelper{
    static final String NEWS_CONTENT_TYPE ="content-type:\"/page/enpagebepmavin\" "
    ...
    EnRecipeSearchHelper(elasticsearch, UrlTransformationService urlTransformationService) {
