...
class EnPolicySearchHelper{
    static final String POLICY_CONTENT_TYPE ="content-type:\"/page/enpagechinhsach\" "
    ...
    EnPolicySearchHelper(elasticsearch, UrlTransformationService urlTransformationService) {
