...
class EnGroupProductSearchHelper {
    static final String PRODUCT_CONTENT_TYPE_QUERY = "content-type:\"/page/enpagespchitiet\""
    ...
    EnGroupProductSearchHelper(elasticsearch, UrlTransformationService urlTransformationService) {
