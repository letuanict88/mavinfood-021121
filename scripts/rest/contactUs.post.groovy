...
service.sendEmail("contact@mavinfood.com", "online.mavinfood@gmail.com", null, 
                  "<strong>Họ Tên: </strong>" + "params.name" + "<br/>" + "<strong>Email: </strong>" + "params.email" +"<br/>" + "<strong>Số điện thoại: </strong>" 
